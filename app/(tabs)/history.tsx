...
function formatDate(dateString: string) {
  ...
  // Create Data object: DD/MM/YYYY -> new Date(YYYY, MM-1, DD)
...
export default function HistoryScreen() {
  ...
  const handleDelete = async (expense: Expense) => {
    Alert.alert(
      'Xóa khoản chi',
      `Bạn có chắc chắn muốn xóa khoản chi cho ${expense.tag} ${expense.price}Đ?`,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert('Success', 'Xóa khoản chi tiêu thành công!');
      ...
      >
        ...
        <Card style={styles.header}>
          <View style={styles.headerContent}>
            <Text style={[styles.title, { color: colors.text }]}>📊 Lịch sử chi tiêu</Text>
            <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
              Theo dõi lịch sử chi tiêu của bạn
            </Text>
          </View>
        </Card>
        ...
        {/* Month/Year Selector */}
        <Card>
          <Text style={[styles.sectionTitle, { color: colors.text }]}>Chọn khoảng thời gian</Text>
          <View style={styles.pickerContainer}>
            <View style={[styles.pickerWrapper, {
              ...
              <Picker
                ...
                onValueChange={(itemValue) => {
                  console.log('Month changed to:', itemValue);
            ...
            <View style={[styles.pickerWrapper, {
              ...
              <Picker
                ...
                onValueChange={(itemValue) => {
                  console.log('Year changed to:', itemValue);
        ...
        {loading ? (
          ...
          <>
              ...
              <>
                ...
                <Card>
                  ...
                  <View style={styles.chartContainer}>
                    <LineChart
                      ...
                      chartConfig={{
                        ...
                        yAxisMin: 0,
                        // @ts-ignore
                        yAxisMax: lineChartData.maxValue * 1.1,
                      }}
                      bezier
                      style={{
                        marginVertical: 8,
                      ...
                      fromZero
                      renderCustomYLabel={(label: string) => {
                        const value = parseFloat(label) * 1000;
                        return isNaN(value)
                          ? ''
                  ...
                  <Text style={[styles.chartSubtitle, { color: colors.textSecondary }]}>
                    Xu hướng chi tiêu hàng ngày trong tháng {months[selectedMonth - 1]} {selectedYear}
                  </Text>
                </Card> */}
            ...
            {/* Expense List */}
            <Section title="💳 Tất cả khoản chi" subtitle="Chạm vào bất kỳ khoản chi để xem chi tiết">
              {/* Filter & Sort Bar */}
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <View style={{
                    ...
                    <Picker
                      ...
                      dropdownIconColor={colors.textSecondary}
                    >
                      <Picker.Item label="Tất cả" value="" color={isDark ? '#000000ff' : colors.text} />
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <View style={{
                    ...
                    <Picker
                      ...
                      dropdownIconColor={colors.textSecondary}
                    >
                      <Picker.Item label="Theo ngày tháng" value="date" color={isDark ? '#000000ff' : colors.text} />
                      <Picker.Item label="Theo giá trị" value="price" color={isDark ? '#000000ff' : colors.text} />
                    </Picker>
                  </View>
                </View>
              </View>
              ...
              {filteredSortedExpenses.length === 0 ? (
                <Card style={styles.emptyCard}>
                  ...
                  <Text style={[styles.emptyText, { color: colors.textSecondary }]}>
                    Không tìm thấy khoản chi nào cho {months[selectedMonth - 1]} {selectedYear}
                  </Text>
                  <Text style={[styles.emptySubtext, { color: colors.placeholder }]}>
                    Bắt đầu theo dõi bằng cách thêm khoản chi đầu tiên của bạn!
                  </Text>
                </Card>
              ) : (
        ...
        <View style={[styles.modalContainer, { backgroundColor: colors.background }]}>
          ...
          {selectedExpense && (
            <ScrollView style={styles.modalContent}>
              ...
              {/* Delete Button */}
              <Button
                title={deleting ? "Deleting..." : "🗑️ Xóa khoản chi"}
