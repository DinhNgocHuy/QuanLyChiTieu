...
export default function GoalsScreen() {
  ...
  const handleAddGoal = async () => {
    ...
    try {
      ...
      setGoal('');
      Alert.alert('Success', 'Thêm mục tiêu thành công! 🎯');
  ...
  const handleDeleteGoal = async (goalItem: Goal) => {
    Alert.alert(
      'Xóa mục tiêu',
      `Bạn có chắc chắn muốn xóa mục tiêu này không?: "${goalItem.text}"?`,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert('Success', 'Xóa mục tiêu thành công!');
  ...
  return (
    ...
    >
      ...
      <Card style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
            Cài đặt và theo dõi mục tiêu hàng tháng của bạn
          </Text>
        </View>
      </Card>
      ...
      <Card>
        <View style={styles.progressHeader}>
          ...
          <Text style={[styles.progressText, { color: colors.primary }]}>
            {completedGoals}/{totalGoals} hoàn thành
          </Text>
        </View>
      ...
      {/* Add Goal Section */}
      <Card>
        <Text style={[styles.sectionTitle, { color: colors.text }]}>Đặt mục tiêu mới</Text>
        <View style={styles.addGoalContainer}>
          <View style={[styles.inputWrapper, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            <TextInput
              style={[styles.goalInput, { color: colors.text }]}
              placeholder="Bạn muốn đạt được mục tiêu gì trong tháng này?"
          ...
          <Animated.View style={{ transform: [{ scale: addBtnAnim }] }}>
            <Button
              title={addingGoal ? "Adding..." : "Thêm mục tiêu"}
      ...
      {/* Goals List */}
      <Section title="📋 Mục tiêu của bạn" subtitle="Nhấn để đánh dấu là hoàn thành">
        {goalsLoading ? (
          ...
          <Card style={styles.emptyCard}>
            ...
            <Text style={[styles.emptyText, { color: colors.textSecondary }]}>
              Không có mục tiêu nào được đặt ra cho {getMonthYearString(selectedMonth, selectedYear)}
            </Text>
            <Text style={[styles.emptySubtext, { color: colors.placeholder }]}>
              Bắt đầu bằng cách thêm mục tiêu đầu tiên của bạn ở trên!
            </Text>
          </Card>
        ) : (
